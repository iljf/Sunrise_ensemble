...
from test import ensemble_test, test, test_minigrid
import wandb
...
if args.evaluate:
    ...
    # KM: test code
    avg_reward, avg_Q = test_minigrid(args, 0, dqn_list, val_mem, metrics, results_dir,
    ...
    for T in trange(1, args.T_max + 1):
        ...
        if T >= args.learn_start:
            ...
            if T % args.evaluation_interval == 0:
                ...
                avg_reward, avg_Q = test_minigrid(args, T, dqn_list, val_mem, metrics, results_dir,
